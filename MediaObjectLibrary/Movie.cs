...
namespace MediaObjectLibrary
{
    ...
    class Movie : IMovie
    {
        ...
        private string _Id, _title, _Rating, _Released, _Runtime, _Plot;
        ...
        public Movie(string id, string title, string rating, string released, string plot)
        {
            _Id = id;
            _title = title;
            _Rating = rating;
        ...
        public Movie(string id, string title, string rating, string released, string plot,string runtime)
        {
            _Id = id;
            _title = title;
            _Rating = rating;
